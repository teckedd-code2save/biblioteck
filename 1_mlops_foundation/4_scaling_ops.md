...
> This process is vital. If the inference server goes down (e.g., due to an Out-of-Memory error), the load balancer should stop sending traffic to the backend until the model is back online.
...
### 🗺️ Navigation
**Previous:** [Deep Dive: Whisper Twi Component](./3_deep_dive_whisper_twi.md)  
**Next Chapter:** [Article 4: Why Your Agent Needs a Sandbox](../2_agent_sandboxing/5_why_sandboxing.md)  
